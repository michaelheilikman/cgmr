      ...
      if(filter_var($recup_mail,FILTER_VALIDATE_EMAIL)) {
         ...
         if($mailexist_count == 1) {
            ...
            try {
               ...
               $mail->Username   = 'noreplyifip@ifip.asso.fr';                  // SMTP username
               $mail->Password   = 'swgrt,1g$';                               // SMTP password
               $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
               $mail->CharSet = 'UTF-8';
               $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above
           
               //Recipients
               $mail->setFrom('noreplyifip@ifip.asso.fr', 'noreply.ifip');
               ...
               <body>
                  <div align="center">
                     ...
                     <tr>
                        <td colspan="3">
                           <center><img src="'.$liveURL.'/img/'.$logo.'" height="100"></center>
                        </td>
                     </tr>
                     ...
                     <tr>
                        <td width="20"></td>
                        <td>
                              <h2>Bonjour '.strtoupper($prenom[0]->prenom).' '.strtoupper($prenom[0]->nom).',</h2>
                     ...
                     <tr>
                        <td colspan="3" bgcolor="#000000" color:#ffffff;>
                           <center color:#ffffff;><a style="font-size:12px;color:#ffffff;" href="'.$liveURL.'">'.$liveURL.'</a> | <a style="font-size:12px;color:#ffffff;" href="mailto:'.$administrateur.'">contactez-nous</a></center>
                        </td>
                     </tr>
